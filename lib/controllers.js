  ...
  */
  ...
  Students = (function() {
    ...
    Students.prototype.upload = function(req, res) {
      var among, course_id, extractStudent, extractStudents, handleExcel, isStudent, list, parsed_excel, registerStudent, registerToCourse, student;
      registerStudent = function(student, course) {
        ...
        return new_student.save(function(err, saved_student) {
          ...
          return course.save(function(err) {
            ...
            console.log("NOW");
            return console.log(course.participants);
          });
        });
      };
