(function() {
  var Auth, BasicAuth, Course, Courses, Lecture, Lectures, Registrations, Student, Students, User, async, auth, models, multiparty, xlsx,
      ...
      return Lecture.findById(req.param('id')).populate('course', 'name term').populate('participants', 'name number').exec(function(err, lecture) {
        if (err != null) {
          ...
          if (req.param('opponent') != null) {
            lecture.opponenet = req.param('opponent');
          }
